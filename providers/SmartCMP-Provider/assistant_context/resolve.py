...
from _context_resolver_common import (  # noqa: E402
    ...
    RequestGet,
    build_approval_context_actions,
    build_catalog_context_actions,
    build_request_context_actions,
    build_resource_context_actions,
    exact_catalog_id,
    exact_request_id,
    exact_uuid,
    get_json,
...
def _resolve_pending_approval(
    ...
    *,
    ...
    return success_object(
        ...
        object_actions=build_approval_context_actions(approval_type, approval_id),
    )
...
def _resolve_catalog(
    ...
    *,
    ...
    return success_object(
        ...
        object_actions=build_catalog_context_actions(catalog_id),
    )
...
def _resolve_request(
    ...
    *,
    ...
    return success_object(
        ...
        object_actions=build_request_context_actions(application_type, request_id),
    )
...
def _resolve_resource(
    ...
    *,
    ...
    return success_object(
        ...
        object_actions=build_resource_context_actions(resource_id, expected_kind),
    )
