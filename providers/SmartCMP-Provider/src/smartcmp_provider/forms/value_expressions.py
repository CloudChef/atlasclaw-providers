...
"""Generate field value expressions from declarative source specifications."""
...
from smartcmp_provider.forms.schema_layout import ensure_field_in_root_fieldsets
from smartcmp_provider.forms.schema_scripts import (
    build_model_composition_expression,
    build_model_projection_expression,
)
from smartcmp_provider.forms.value_expression_sources import (
...
def apply_value_expressions(schema: dict[str, Any], value_expressions_json: str) -> list[str]:
    ...
    for request in requests_json:
        ...
        allowed_model_paths = set(properties)
        ...
        try:
            if has_compose:
                ...
                compose_spec = resolve_compose_spec(
                    raw_compose,
                    warnings,
                ...
                projection_fields = parse_projection_fields(
                    request.get("fields"),
                    warnings,
                    allowed_model_paths=allowed_model_paths,
                )
