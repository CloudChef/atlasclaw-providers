...
| Script | Description |
|--------|-------------|
| `scripts/list_all_business_groups.py` | Call the standalone business-group directory endpoint and emit `##BUSINESS_GROUP_DIRECTORY_META_START## ... ##BUSINESS_GROUP_DIRECTORY_META_END##` |
