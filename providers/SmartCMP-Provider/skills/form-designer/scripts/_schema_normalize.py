...
try:
    from _schema_js_validate import validate_javascript_expression, validate_value_expression_contract
except ModuleNotFoundError as exc:
    ...
    validate_value_expression_contract = _schema_js_validate.validate_value_expression_contract
